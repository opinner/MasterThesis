...
for FOLDERNAME in LIST_OF_MSS_FOLDERS:
    ...
    for DATAFILENAME in DATAFILENAMES:
        ...
        for profile in range(number_of_profiles):
            ...
            #???????????????????????????????????????????????????????????????????????????????????????????????????
            #???????????????????????????????????????????????????????????????????????????????????????????????????
            #TODO: Remove fluxes above the threshold
            #???????????????????????????????????????????????????????????????????????????????????????????????????
            #???????????????????????????????????????????????????????????????????????????????????????????????????
            #???????????????????????????????????????????????????????????????????????????????????????????????????
            #???????????????????????????????????????????????????????????????????????????????????????????????????
        ...
        pycno_axarr.plot(transect_longitude,transect_pycnocline,"k")
        pycno_axarr.plot(transect_longitude,transect_pycnocline2,"tab:red")
