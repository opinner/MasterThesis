...
img1_2 = axarr2[2].pcolormesh(distance,interp_pressure,consv_temperature_grid.T)
img1_3 = axarr2[3].pcolormesh(distance,interp_coarse_pressure,np.log10(eps_grid.T), vmax = -7, vmin = -10)
...
img2_3 = axarr1[3].pcolormesh(distance,interp_coarse_pressure,Reynolds_bouyancy_grid.T, vmin = -5, vmax = 100)
...
colorbar(img2_2).set_label("log10(dissipation) [??]")  #set_label("alpha [??]")
colorbar(img2_3).set_label("Reynolds bouyancy number")
