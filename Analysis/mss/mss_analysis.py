...
for FOLDERNAME in LIST_OF_MSS_FOLDERS:
    ...
    for DATAFILENAME in DATAFILENAMES:
        ...
        img1_3 = axarr1[3].pcolormesh(plotmesh_distance,eps_pressure,np.log10(eps_grid.T), vmax = -7, vmin = -10,cmap = cmap)


        img2_0 = axarr2[0].pcolormesh(plotmesh_distance,interp_pressure,density_grid.T,cmap = cmap)
        img2_1 = axarr2[1].pcolormesh(plotmesh_distance,eps_pressure,eps_N_squared_grid.T,vmin = 0, vmax = 0.015,cmap = cmap)
        img2_2 = axarr2[2].pcolormesh(plotmesh_distance,eps_pressure,np.log10(eps_grid.T), vmax = -7, vmin = -10,cmap = cmap)
        img2_3 = axarr2[3].pcolormesh(plotmesh_distance,eps_pressure,eps_Reynolds_bouyancy_grid.T, vmin = -5, vmax = 100,cmap = cmap)
